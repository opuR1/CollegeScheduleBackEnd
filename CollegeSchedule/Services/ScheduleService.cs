...
namespace CollegeSchedule.Services
{
    public class ScheduleService : IScheduleService
    {
        ...
        private static List<ScheduleByDateDto> BuildScheduleDto(List<Schedule> schedules)
        {
            var scheduleByDate = GroupSchedulesByDate(schedules);
            var startDate = schedules.Min(s => s.LessonDate);
            var endDate = schedules.Max(s => s.LessonDate);
